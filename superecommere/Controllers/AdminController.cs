...
using superecommere.Models.DTO.Admin;
...
namespace superecommere.Controllers
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        public AdminController(UserManager<TblUser> userManager,RoleManager<IdentityRole> roleManager)
        {
        ...
        public async Task<ActionResult<IEnumerable<MemberViewDto>>> GetMembers()
        {
            ...
            var users = await _userManager.Users.Where(x => x.UserName != SD.AdminUserName).ToListAsync();
        ...
        public async Task<IActionResult> AddEditMember(MemberAddEditDto model)
        {
            ...
            {
                return Ok(new JsonResult(new { title = "Account Edited", message = $"{model.UserName} has been updated" }));
            }
